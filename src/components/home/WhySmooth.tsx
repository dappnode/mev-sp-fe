...
const whySmooth = [
  ...
  },
  {
    ...
    description:
      'Earn an average of all pool rewards, not just your individual blocks.',
  },
  {
    name: '🔍 Full transparency:',
    description:
      'Track all blocks, MEV, and validator performance on the dashboard.',
  },
  {
    name: '✅ Get started easily:',
    description:
      'Just update your fee recipient and claim rewards after proposals. Simple and secure.',
  },
]
          ...
          <div className="mx-auto flex max-w-2xl flex-col gap-16 rounded-2xl bg-gray-400/5 px-6 py-16 shadow sm:p-8 lg:mx-0 lg:max-w-none lg:flex-row lg:items-center lg:py-20 xl:gap-x-20 xl:px-20">
            ...
            <div className="w-full flex-auto">
              <h2 className="text-3xl font-bold tracking-tight text-DAppDeep dark:text-DAppDarkText sm:text-4xl">
                Why <span className="text-purple-600">Smooth</span>?
              </h2>
              ...
              <ul
                ...
                {whySmooth.map((feature) => (
                  <li
                    key={feature.name}
                    className="flex cursor-default gap-x-3 rounded-md p-2 transition duration-300 hover:scale-110 hover:text-purple-600">
                    <p className="text-sm">
              ...
              <div className="mt-10 flex">
                <Link
                  className="group text-sm font-semibold leading-6 text-purple-600"
                  href="/dashboard">
                  Go to dashboard{' '}
                  <span
                    aria-hidden="true"
