...
export default function HowToSubscribe() {
  ...
  const steps = [
    ...
    },
    {
      ...
      description:
        'You will subscribe to Smooth the next time your validator proposes a block and sends its execution rewards to the pool',
      status: 'complete',
      isLink: false,
      href: '',
    },
    ...
    },
    {
      ...
      description: (
        <div className="flex items-center justify-center">
          <span>
            <span style={{ textDecoration: 'underline' }}>Read more</span> on
            our documentation for detailed information{' '}
          </span>
          <svg
            className="icon-learn-smooth ml-1 inline-block h-4 w-4"
            fill="none"
            stroke="currentColor"
            strokeWidth="1.5"
            viewBox="0 0 24 24"
                    ...
                    {step.isLink ? (
                      <Link
                        ...
                        className={`group relative flex items-start ${
                          step.isLink ? 'hover:text-purple-600' : ''
                        }`}>
                        ...
                        <span className="ml-4 flex min-w-0 flex-col">
                          ...
                          <span className="text-base text-DAppDeep dark:text-DAppGray">
                            {step.description}
                          </span>
                        </span>
                      </Link>
                      ...
                      <div className="group relative flex cursor-default items-start">
                        <span className="flex h-9 items-center">
                          <span className="relative z-10 flex h-8 w-8 items-center justify-center rounded-full bg-purple-600">
                            <CheckIcon
                              aria-hidden="true"
                              className="h-5 w-5 text-white"
                            />
