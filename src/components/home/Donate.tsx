    ...
    <div className="mt-32 rounded-3xl bg-gradient-to-br from-DAppPurple/900 to-DAppBlue text-center transition duration-300 ease-in-out md:hover:scale-105">
      <div className="mx-auto max-w-7xl p-6 py-12 sm:py-16 lg:px-8">
        ...
        <p className="mx-auto mt-6 max-w-xl text-lg leading-8 text-gray-300">
          Contribute to the pool and increase solo staker&apos;s revenue.
          It&apos;s a great way of supporting the true decentralized node
          runners that keep Ethereum decentralized at scale.
        </p>
        <div
          className="mt-8 flex w-[220px] items-center justify-center pt-10 "
          style={{ margin: 'auto' }}>
