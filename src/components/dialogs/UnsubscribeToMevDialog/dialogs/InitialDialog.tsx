  ...
  return (
    <>
      ...
      <div className="text-DAppDeep dark:text-DAppDarkText">
        ...
        <p className="mb-5 mt-1 text-center text-base font-normal leading-7 tracking-wide sm:mt-3 sm:px-2 sm:text-lg">
          When unsubscribing a validator, all its pending rewards are
          redistributed back to the pool.
          <br />
          <br />
          It is recommended to unsubscribe a validator soon after it has
          proposed a block to minimize lost pending rewards.
          <br />
        </p>
      </div>
      <div>
