  ...
  return (
    <div className="relative w-full">
      ...
      <div className="absolute left-0 top-28 flex h-full w-full flex-col items-center px-8">
        ...
        <p className="mx-6 mb-6 text-center lg:mx-12 xl:mx-24">Register your validators to seamlessly interact with your Withdrawal Address. No need to alter your Withdrawal Address; it simply acts as the controller!</p>
        <w3m-button />
      </div>
    </div>
  )
