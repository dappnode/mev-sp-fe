...
export const SITE_NAME = 'Dappnode Smooth'
export const SITE_DESCRIPTION =
  'Dappnode Smooth is a dashboard for Ethereum validators to join and receive a share of block proposal fees, ensuring a more stable and predictable return on investment.'
